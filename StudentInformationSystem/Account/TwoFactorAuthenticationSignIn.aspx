<%@ Page Title="Zweistufige Authentifizierung" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="StudentInformationSystem.TwoFactorAuthenticationSignIn" %>
    ...
    <main aria-labelledby="title">
        ...
        <asp:PlaceHolder runat="server" ID="sendcode">
            <section>
                ...
                <asp:DropDownList runat="server" ID="Providers">
                        ...
                        <asp:Button Text="Absenden" ID="ProviderSubmit" OnClick="ProviderSubmit_Click" CssClass="btn btn-outline-dark" runat="server" />
                    </div>
                </div>
            </section>
        </asp:PlaceHolder>
        <asp:PlaceHolder runat="server" ID="verifycode" Visible="false">
            <section>
                ...
                <div class="form-group">
                    <div class="offset-md-2 col-md-10">
                        <asp:Button Text="Absenden" ID="CodeSubmit" OnClick="CodeSubmit_Click" CssClass="btn btn-outline-dark" runat="server" />
                    </div>
                </div>
            </section>
        </asp:PlaceHolder>
